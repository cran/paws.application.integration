...
.mq$update_broker_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AutoMinorVersionUpgrade = structure(logical(0), tags = list(locationName = "autoMinorVersionUpgrade", type = "boolean")), BrokerId = structure(logical(0), tags = list(location = "uri", locationName = "broker-id", type = "string")), Configuration = structure(list(Id = structure(logical(0), tags = list(locationName = "id", type = "string")), Revision = structure(logical(0), tags = list(locationName = "revision", type = "integer"))), tags = list(locationName = "configuration", type = "structure")), EngineVersion = structure(logical(0), tags = list(locationName = "engineVersion", type = "string")), HostInstanceType = structure(logical(0), tags = list(locationName = "hostInstanceType", type = "string")), Logs = structure(list(Audit = structure(logical(0), tags = list(locationName = "audit", type = "boolean")), General = structure(logical(0), tags = list(locationName = "general", type = "boolean"))), tags = list(locationName = "logs", type = "structure")), SecurityGroups = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "securityGroups", type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}

.mq$update_broker_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(AutoMinorVersionUpgrade = structure(logical(0), tags = list(locationName = "autoMinorVersionUpgrade", type = "boolean")), BrokerId = structure(logical(0), tags = list(locationName = "brokerId", type = "string")), Configuration = structure(list(Id = structure(logical(0), tags = list(locationName = "id", type = "string")), Revision = structure(logical(0), tags = list(locationName = "revision", type = "integer"))), tags = list(locationName = "configuration", type = "structure")), EngineVersion = structure(logical(0), tags = list(locationName = "engineVersion", type = "string")), HostInstanceType = structure(logical(0), tags = list(locationName = "hostInstanceType", type = "string")), Logs = structure(list(Audit = structure(logical(0), tags = list(locationName = "audit", type = "boolean")), General = structure(logical(0), tags = list(locationName = "general", type = "boolean"))), tags = list(locationName = "logs", type = "structure")), SecurityGroups = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "securityGroups", type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
