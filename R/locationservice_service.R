...
#'  \link[=locationservice_calculate_route]{calculate_route} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_calculate_route_matrix]{calculate_route_matrix} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_cancel_job]{cancel_job} \tab CancelJob cancels a job that is currently running or pending\cr
...
#'  \link[=locationservice_create_map]{create_map} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_create_place_index]{create_place_index} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_create_route_calculator]{create_route_calculator} \tab This operation is no longer current and may be deprecated in the future\cr
...
#'  \link[=locationservice_delete_map]{delete_map} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_delete_place_index]{delete_place_index} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_delete_route_calculator]{delete_route_calculator} \tab This operation is no longer current and may be deprecated in the future\cr
...
#'  \link[=locationservice_describe_map]{describe_map} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_describe_place_index]{describe_place_index} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_describe_route_calculator]{describe_route_calculator} \tab This operation is no longer current and may be deprecated in the future\cr
...
#'  \link[=locationservice_forecast_geofence_events]{forecast_geofence_events} \tab This action forecasts future geofence events that are likely to occur within a specified time horizon if a device continues moving at its current speed\cr
...
#'  \link[=locationservice_get_job]{get_job} \tab GetJob retrieves detailed information about a specific job, including its current status, configuration, and error information if the job failed\cr
#'  \link[=locationservice_get_map_glyphs]{get_map_glyphs} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_get_map_sprites]{get_map_sprites} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_get_map_style_descriptor]{get_map_style_descriptor} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_get_map_tile]{get_map_tile} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_get_place]{get_place} \tab This operation is no longer current and may be deprecated in the future\cr
...
#'  \link[=locationservice_list_jobs]{list_jobs} \tab ListJobs retrieves a list of jobs with optional filtering and pagination support\cr
#'  \link[=locationservice_list_keys]{list_keys} \tab Lists API key resources in your Amazon Web Services account\cr
#'  \link[=locationservice_list_maps]{list_maps} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_list_place_indexes]{list_place_indexes} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_list_route_calculators]{list_route_calculators} \tab This operation is no longer current and may be deprecated in the future\cr
...
#'  \link[=locationservice_search_place_index_for_position]{search_place_index_for_position} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_search_place_index_for_suggestions]{search_place_index_for_suggestions} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_search_place_index_for_text]{search_place_index_for_text} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_start_job]{start_job} \tab StartJob starts a new asynchronous bulk processing job\cr
...
#'  \link[=locationservice_update_map]{update_map} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_update_place_index]{update_place_index} \tab This operation is no longer current and may be deprecated in the future\cr
#'  \link[=locationservice_update_route_calculator]{update_route_calculator} \tab This operation is no longer current and may be deprecated in the future\cr
...
locationservice <- function(config = list(), credentials = list(), endpoint = NULL, region = NULL) {
  ...
  svc <- .locationservice$operations
...
.locationservice$operations <- list()

.locationservice$metadata <- list(
  service_name = "locationservice",
  endpoints = list("^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.amazonaws.com", global = FALSE), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.amazonaws.com.cn", global = FALSE), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.amazonaws.com", global = FALSE), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.c2s.ic.gov", global = FALSE), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.sc2s.sgov.gov", global = FALSE), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.cloud.adc-e.uk", global = FALSE), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.csp.hci.ic.gov", global = FALSE), "^eusc\\-(de)\\-\\w+\\-\\d+$" = list(endpoint = "geo.{region}.amazonaws.eu", global = FALSE)),
  service_id = "Location",
